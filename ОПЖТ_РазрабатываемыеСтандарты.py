...
start_url = main_url + '/category/tehnicheskoe-regulirovanie/razrabatyvaemye-standarty/'
...
Hlc.create_hyperlinks_from_names('!Список разрабатываемых стандартов ОПЖТ.html', file_names, document_names)
