# Данная программа скачивает стандарты ЕСПД с сайта Техэксперт.
# http://docs.cntd.ru/
...
parsed_page = ws.page_parser_from_file('espd.html')
...
document_names = [name.replace(' Единая система программной документации (ЕСПД).', '') for name in document_names]
failed_downloads = []
...
with open('espd_failed.txt', 'w', encoding = 'utf-8') as f_out:
