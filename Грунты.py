# Данная программа скачивает стандарты по грунтам с сайта Техэксперт.
# http://docs.cntd.ru/
...
parsed_page = ws.page_parser_from_file('grunt.html')
document_links = list(ws.get_attribute_values_by_element_value(parsed_page, 'a', 'href', 'Грунты. '))
...
with open('grunt_failed.txt', 'w', encoding = 'utf-8') as f_out:
