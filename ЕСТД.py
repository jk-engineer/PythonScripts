# Данная программа скачивает стандарты ЕСТД с сайта Техэксперт.
# http://docs.cntd.ru/
...
parsed_page = ws.page_parser_from_file('estd.html')
...
document_names = [name.replace(' Единая система технологической документации (ЕСТД).', '') for name in document_names]
failed_downloads = []
...
with open('estd_failed.txt', 'w', encoding = 'utf-8') as f_out:
