# Программа для скачивания книг с сайта https://www.chem21.info.
...
main_url = 'https://www.chem21.info'
#page_url = str(sys.argv[1])
page_url = 'https://www.chem21.info/page/157186087249203188078208028012103253038109126055/'
print(page_url)
file_counter = 0
page_number = 0
while True:
    ...
    page_number += 1
    file_name = f'{page_number:03}.png'
