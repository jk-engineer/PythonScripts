# Данная программа скачивает стандарты ЕСКД с сайта Техэксперт.
# http://docs.cntd.ru/
...
parsed_page = ws.page_parser_from_file('eskd.html')
...
document_names = [name.replace(' Единая система конструкторской документации (ЕСКД).', '') for name in document_names]
failed_downloads = []
...
with open('eskd_failed.txt', 'w', encoding = 'utf-8') as f_out:
